...
{
    // --- Singleton Instance ---
    private static GameBridgeManager _instance;
    public static GameBridgeManager Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<GameBridgeManager>();
                if (_instance == null)
                {
                    GameObject go = new GameObject("GameBridgeManager_AutoCreated");
                    _instance = go.AddComponent<GameBridgeManager>();
                    Debug.LogWarning("[GameBridgeManager C#] GameBridgeManager instance was not found in scene, auto-created one. Ensure a GameBridgeManager object exists in your scene.");
                }
            }
            return _instance;
        }
    ...
    void Awake()
    {
        ...
        {
            _instance = this;
            // Optional: DontDestroyOnLoad(gameObject); // If GameBridgeManager should persist
        }
        else if (_instance != this)
        {
            Debug.LogWarning("[GameBridgeManager C#] Another instance of GameBridgeManager found, destroying this one.");
            Destroy(gameObject);
        }
    }
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnWalletConnected received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnWalletSelectionNeeded received: {jsonData}");
    ...
    {
        Debug.LogWarning($"[GameBridgeManager C#] OnWalletConnectionError received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnWalletConnectionStatus received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnPublicKeyReceived received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnAvailableWalletsReceived received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnWalletSelectAttempted received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnAssetsLoadingStateChanged received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnSolBalanceUpdated received: {jsonData}");
    ...
    {
        Debug.LogWarning($"[GameBridgeManager C#] OnSolBalanceUpdateFailed received: {jsonData}");
    ...
    {
        Debug.LogWarning($"[GameBridgeManager C#] OnHeliusWarning received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnTransactionSubmitting received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnTransactionSubmitted received: {jsonData}");
    ...
    {
        Debug.LogError($"[GameBridgeManager C#] OnTransactionError received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnWithdrawalResponse received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnCurrentNetworkReceived received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnUnityReady (from web) received: {jsonData}");
    ...
    {
        Debug.LogError($"[GameBridgeManager C#] OnUnityLoadError received: {jsonData}");
    ...
    {
        Debug.LogWarning($"[GameBridgeManager C#] OnWebGLContextLost received: {jsonData}");
    ...
    {
        Debug.Log($"[GameBridgeManager C#] OnWebGLContextRestored received: {jsonData}");
    ...
    */
    ...
    void Start()
    {
        Debug.Log("[GameBridgeManager C#] GameBridgeManager Started. Instance is set up. Waiting for OnUnityReady from web.");
